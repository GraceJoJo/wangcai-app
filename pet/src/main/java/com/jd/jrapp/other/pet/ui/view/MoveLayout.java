...
//                        break;
                ...
                RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(screenWidth, oriBottom - oriTop);
                if (isMove) {
                    lp.setMargins(oriLeft, oriTop, 0, 0);
                } else {
                    lp.setMargins(0, screenHeight-(oriBottom - oriTop), 0, 0);
                }
                setLayoutParams(lp);
                Log.e(TAG, "onTouchEvent: set layout width=" + (oriRight - oriLeft) + " height=" + (oriBottom - oriTop));
                Log.e(TAG, "onTouchEvent: marginLeft=" + oriLeft + "  marginTop" + oriTop+ "oriBottom"+oriBottom);
                break;
        }
